...
while True:
    ...
    # Error handling menu utama
    try:
        pilihan = int(input("Masukkan pilihan anda: "))
    except ValueError:
        print("Masukkan pilihan yang berupa angka")

    # Memastikan bahwa pilihan user ada di menu
    if pilihan not in banyakPilihan:
    ...
    match pilihan:
        ...
        case 1:
            ...
            # Menampilkan menu kilometer
            menu_kilometer()

            # Error handling menu kilometer
            try:
            ...
            # Output dan error handling hasil input user
            try:
                match pilihan2:
                    case 1:
            ...
            # Ingin melanjutkan program atau tidak
        ...
        case 2:
            ...
            # Menampilkan menu hektometer
            menu_hektometer()

            # Error handling menu hektometer
            try:
                pilihan2 = int(input("Masukkan pilihan anda: "))
            except ValueError:
                print("Masukkan pilihan yang berupa angka")
        ...
        case 3:
            ...
            # Menampilkan menu dekameter
            menu_dekameter()

            # Error handling menu dekameter
            try:
                pilihan2 = int(input("Masukkan pilihan anda: "))
            except ValueError:
                print("Masukkan pilihan yang berupa angka")
        ...
        case 4:
            ...
            # Menampilkan menu meter
            menu_meter()

            # Error handling menu meter
            try:
                pilihan2 = int(input("Masukkan pilihan anda: "))
            except ValueError:
                print("Masukkan pilihan yang berupa angka")
        ...
        case 5:
            ...
            # Menampilkan menu desimeter
            menu_desimeter()

            delay(1)

            # Error handling menu desimeter
            try:
                pilihan2 = int(input("Masukkan pilihan anda: "))
            except ValueError:
                print("Masukkan pilihan yang berupa angka")
        ...
        case 6:
            ...
            # Menampilkan menu centimeter
            menu_centimeter()

            # Error handling menu centimeter
            try:
                pilihan2 = int(input("Masukkan pilihan anda: "))
            except ValueError:
                print("Masukkan pilihan yang berupa angka")
        ...
        case 7:
            ...
            # Menampilkan menu milimeter
            menu_milimeter()

            # Error handling menu milimeter
            try:
                pilihan2 = int(input("Masukkan pilihan anda: "))
            except ValueError:
                print("Masukkan pilihan yang berupa angka")
        ...
        case 8:
            # Membersihkan terminal dan menghentikan program
            clear()
            break
